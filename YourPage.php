...
<body id="top">
   ...
   <section id="intro">   
   	...
   	<ul class="intro-social">        
         <li><a href="<?php echo $row4[0]; ?>"><i class="fa fa-facebook"></i></a></li>
         <li><a href="<?php echo $row4[1]; ?>"><i class="fa fa-linkedin"></i></a></li>
         <li><a href="<?php echo $row4[2]; ?>"><i class="fa fa-twitter"></i></a></li>
         <li><a href="<?php echo $row4[3]; ?>"><i class="fa fa-github"></i></a></li>
         <li><a href="<?php echo $row4[4]; ?>"><i class="fa fa-instagram"></i></a></li>
      </ul> <!-- /intro-social -->      	
